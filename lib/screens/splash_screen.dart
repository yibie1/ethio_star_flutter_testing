import 'package:ethiostar_testing/screens/login.dart';
...
class _SplashScrenState extends State<SplashScren> with TickerProviderStateMixin{
  ...
  void initState() {
    ...
    _scale2Animation = Tween<double>(
      ...
      if (status == AnimationStatus.completed) {
        Navigator.push(context, PageTransition(type: PageTransitionType.fade, child: const Login()));
      }
    });
  }
            ...
            Container(
              ...
              child: Column(
                ...
                children: <Widget>[
                  ...
                  SizedBox(height: 15,),
                  FadeAnimation(1.3, Text("Ethio Stars", 
